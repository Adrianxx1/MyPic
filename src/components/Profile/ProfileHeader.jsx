import { Avatar, AvatarGroup, Button, Flex } from "@chakra-ui/react";
...
const ProfilePost = () => {
    return <Flex gap={{base:4,sm:10}} py={10} direction={{base:"column",sm:"row"}}>
        ...
        <Flex alignItems={"center"} gap={4}>
            <Text fontSize={"sm"} fonrWeight={"bold"}>GAYmer😍</Text>
        </Flex>
            <Text fontSize={"sm"}>Me gustan los hombres y soy racista</Text>
        </VStack>
    </Flex>
};
