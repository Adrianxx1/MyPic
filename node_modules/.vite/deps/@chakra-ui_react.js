...
var useSafeLayoutEffect = Boolean(globalThis?.document) ? import_react10.useLayoutEffect : import_react10.useEffect;
...
var useSafeLayoutEffect2 = Boolean(globalThis?.document) ? import_react19.useLayoutEffect : import_react19.useEffect;
...
function omitReactElements(props) {
  return Object.fromEntries(
    Object.entries(props).filter(([key, value]) => {
      return value !== void 0 && key !== "children" && !(0, import_react38.isValidElement)(value);
    })
  );
}
...
function isTargetMenuItem(target) {
  return isHTMLElement2(target) && !!target?.getAttribute("role")?.startsWith("menuitem");
}
